...
def test_build_diff_blocks_simple_change() -> None:
    """验证：build diff blocks simple change。"""
    old_text = """
Line one
Line two
Line three
...
def test_build_diff_blocks_insert_only() -> None:
    """验证：build diff blocks insert only。"""
    old_text = """
Line one
Line two
""".strip()
...
def test_build_diff_blocks_delete_only() -> None:
    """验证：build diff blocks delete only。"""
    old_text = """
Line one
Line two
Line three
...
def test_build_diff_blocks_multiline_replace() -> None:
    """验证：build diff blocks multiline replace。"""
    old_text = """
Alpha
Bravo
Charlie
...
def test_build_diff_blocks_complex_change() -> None:
    """验证：build diff blocks complex change。"""
    old_text = """
Line one
Line two
Line three
...
def test_build_diff_blocks_split_by_context_window() -> None:
    """验证：build diff blocks split by context window。"""
    old_text = """
Line 1
Line 2
Line 3
...
def test_build_diff_blocks_old_empty() -> None:
    """验证：build diff blocks old empty。"""
    old_text = ""
    new_text = """
Line 1
Line 2
...
def test_build_diff_blocks_new_empty() -> None:
    """验证：build diff blocks new empty。"""
    old_text = """
Line 1
Line 2
""".strip()
...
def test_build_diff_blocks_both_empty() -> None:
    """验证：build diff blocks both empty。"""
...
def test_build_diff_blocks_equal_text() -> None:
    """验证：build diff blocks equal text。"""
    text = """
Line 1
Line 2
""".strip()
...
def test_format_unified_diff_with_path() -> None:
    """验证：format unified diff with path。"""
    old_text = "alpha\nbeta\n"
    new_text = "alpha\nbravo\n"
...
def test_format_unified_diff_without_path() -> None:
    """验证：format unified diff without path。"""
    old_text = "alpha\nbeta\n"
    new_text = "alpha\nbravo\n"
...
def test_format_unified_diff_without_header() -> None:
    """验证：format unified diff without header。"""
    old_text = "alpha\nbeta\n"
    new_text = "alpha\nbravo\n"
