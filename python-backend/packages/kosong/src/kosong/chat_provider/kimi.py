...
class Kimi:
    ...
    async def generate(
        ...
        if generation_kwargs.get("reasoning_effort") is None:
    ...
    def with_thinking(self, effort: ThinkingEffort) -> Self:
        ...
        if reasoning_effort is None:
            copied = copy.copy(new_self)
            copied._generation_kwargs = copy.deepcopy(new_self._generation_kwargs)
            copied._generation_kwargs.pop("reasoning_effort", None)
            return copied
        return new_self.with_generation_kwargs(reasoning_effort=reasoning_effort)
