...
def test_simple_toolset():
    ...
    with patch("kosong.tooling.simple.logger") as logger_mock:
    ...
    logger_mock.exception.assert_called_once_with(
        "Tool execution raised exception tool_name={tool_name} tool_call_id={tool_call_id} arguments={arguments}",
        tool_name="raise",
        tool_call_id="4",
        arguments={},
    )
    ...
    assert call(
        "Tool returned error tool_name={tool_name} tool_call_id={tool_call_id} arguments={arguments} message={message}",
        tool_name="plus",
        tool_call_id="3",
        arguments={"a": 1},
        message=results[2].return_value.message,
    ) in logger_mock.error.call_args_list
    assert call(
        "Tool returned error tool_name={tool_name} tool_call_id={tool_call_id} arguments={arguments} message={message}",
        tool_name="error",
        tool_call_id="6",
